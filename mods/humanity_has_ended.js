...
runAfterLoad(function() {
    ...
    if(enabledMods.includes("mods/fey_and_more.js")) {
		//shit elements as impurities {
			eLists.IMPURITY.push("humanity_has_ended");
			eLists.IMPURITY.push("molten_glass");
			eLists.IMPURITY.push("hydrogen");
			eLists.IMPURITY.push("helium");
			eLists.IMPURITY.push("water");
		//}
